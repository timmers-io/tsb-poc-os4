...
### Install Istio on the tier1 cluster
...
> Note the setting: tier1Cluster: true  
...
### Using istio-csr
We will use the common ca we created in the pki folder
...
### Creating the Istio control plane for the cluster
